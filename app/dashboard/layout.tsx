...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // Définir les éléments de navigation avec leurs permissions requises
  const navigationItems = [
    ...
    },
    {
      ...
      icon: DropletIcon,
      permission: "view_blood_donation",
    },
    {
      name: "Patients",
  ...
  const navigation = navigationItems.filter((item) => hasPermission(userRole as any, item.permission as any))
