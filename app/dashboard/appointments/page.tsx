...
export default function AppointmentsPage() {
  ...
  const canCreateAppointment = hasPermission(userRole as any, "create_appointment")
  const canEditAppointment = hasPermission(userRole as any, "edit_appointment")
  const canCancelAppointment = hasPermission(userRole as any, "cancel_appointment")
  ...
  const handleCancelAppointment = (id: string) => {
    if (!canCancelAppointment) {
      toast({
        title: "Accès refusé",
        description: "Vous n'avez pas la permission d'annuler des rendez-vous.",
        variant: "destructive",
      })
      return
    }
